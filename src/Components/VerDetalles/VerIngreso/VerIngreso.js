...
const VerIngreso = ({ isOpen, onClose, ingreso }) => {
  const [isIngresoExpanded, setIsIngresoExpanded] = useState(false);
            ...
            <table className="w-full text-left">
              <tbody className="text-gray-600 dark:text-gray-100">
                <tr>
                  ...
                  <td className="py-1 px-3">{ingreso.subRubro}</td>
                </tr>
                <tr>
                  <td className="font-normal px-3 pt-0 pb-1 border-b border-gray-200 dark:border-gray-800">
                    Denominacion:
                  </td>
                  <td className="py-1 px-3">{ingreso.denominacion}</td>
                </tr>
                <tr>
                  <td className="font-normal px-3 pt-0 pb-1 border-b border-gray-200 dark:border-gray-800">
                    Ingreso:
                  </td>
                  <td className="py-1 px-3">{ingreso.ingreso}</td>
                </tr>
              </tbody>
            </table>
          </div>
