          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex justify-between">
                <span className="font-medium text-white-800">Fecha:</span>
                <span className="text-white-600">{reajuste.fechaReajuste}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-white-800">
                  Cuota 2 Habt:
                </span>
                <span className="text-white-600">{reajuste.cuotaMensualDosHabitacionesEnPesos}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-white-800">
                  Cuota 3 Habt:
                </span>
                <span className="text-white-600">{reajuste.cuotaMensualTresHabitacionesEnPesos}</span>
              </div>
              <div className="flex justify-between">
                <span className="font-medium text-white-800">ValorUr:</span>
                <span className="text-white-600">{reajuste.valorUr || "Ninguno"}</span>
              </div>
            </div>
