...
const HeaderUsuario = ({ setIdentificadorComponente }) => {
  ...
  return (
    <header className="h-16 flex justify-start w-full border-b dark:border-gray-200 border-gray-800 px-4 lg:px-10 z-50 relative">
      <div className="flex dark:text-gray-600 text-gray-400 w-full lg:w-auto">
        <button
          className="lg:hidden text-white dark:text-black  focus:outline-none"
        ...
        <div
          className={`fixed top-0 left-0 h-screen dark:bg-white bg-gray-800 z-50 transition-opacity duration-300 ease-in-out ${
            ...
            <div className="space-y-4 mt-3">
              <div className="relative">
                <button
                  ...
                  className={`w-full py-2 px-4 rounded-md text-left font-semibold flex items-center text-white dark:text-black dark:hover:bg-blue-100 hover:bg-blue-900 ${
                    selectedOption === 37 ? "bg-blue-500 text-white" : ""
                  }`}
                >
                ...
                >
                  ...
                  <a className="text-base">Informes</a>
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="ml-auto flex items-center space-x-4 lg:space-x-7">
        ...
        <div className="relative">
          <button
            ...
            className=" dark:text-gray-600 text-gray-300 focus:outline-none"
          >
          ...
          {mostrarAvisos && (
            <div className="absolute right-0 mt-2 w-64 dark:bg-white bg-gray-700 border dark:border-gray-200 border-gray-800 shadow-lg rounded-md z-10">
              <ul className="py-2">
                {avisos.map((aviso, index) => (
                  <li
                    key={index}
                    className="px-4 py-2 text-sm dark:text-gray-800 text-gray-300 dark:hover:bg-gray-100 hover:bg-gray-600"
                  >
                    {aviso.mensaje}
                  </li>
                ))}
                {avisos.length === 0 && (
                  <li className="px-4 py-2 text-sm dark:text-gray-800 text-gray-300">
                    No hay avisos.
                  </li>
                )}
              </ul>
        ...
        <Menu as="div" className="relative inline-block text-left justify-end">
          <div>
            <MenuButton className="inline-flex w-full justify-center gap-x-1.5 rounded-md px-3 py-2 text-sm font-semibold text-gray-300 dark:text-gray-900 shadow-sm border border-gray-600 dark:border-gray-200">
