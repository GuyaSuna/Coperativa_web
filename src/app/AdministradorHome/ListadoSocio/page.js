...
import { getUr,  getAllSocios,
    getAllRecibos,
    updateSocio,
    getViviendaPorSocio,
    updateVivienda,
    getConveniosVigenteSocio,
    getDevolucionCapital, } from "@/Api/api";
...
import VerSocio from "@/Components/VerDetalles/VerSocio/VerSocio";
import {
    Button,
    Menu,
    MenuButton,
...
export default ListadoSocioPrueba;
