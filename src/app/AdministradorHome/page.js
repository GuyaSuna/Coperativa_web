        ...
        <div className="flex-grow flex overflow-x-hidden">
          <div className="xl:w-72 w-48 flex-shrink-0 border-r border-gray-200 dark:border-gray-800 h-full overflow-y-auto lg:block hidden p-5">
            ...
            <div className="space-y-4 mt-3">
              ...
              <button className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow-lg  hover:ring-2 hover:ring-blue-500 focus:outline-none">
                <div className="flex xl:flex-row flex-col items-center font-medium text-gray-900 dark:text-white pb-2 mb-2 xl:border-b border-gray-200 border-opacity-75 dark:border-gray-700 w-full">
                  <img
                ...
                <div className="flex items-center w-full">
                  <div className="text-xs py-1 px-2 leading-none dark:bg-gray-900 bg-green-100 text-blue-500 rounded-md">
                    Capital
                  </div>
              ...
              <button className="bg-white p-3 w-full flex flex-col rounded-md dark:bg-gray-800 shadow hover:ring-2 hover:ring-blue-500 focus:outline-none">
                ...
                <div className="flex items-center w-full">
                  <div className="text-xs py-1 px-2 leading-none dark:bg-gray-900 bg-yellow-100 text-blue-500 rounded-md">
                    Capital
                  </div>
